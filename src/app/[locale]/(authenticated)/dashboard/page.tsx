...
export default function DashboardPage() {
  ...
  const quickActions: QuickActionProps[] = [
    ...
    },
    {
      ...
      icon: Building2,
      label: '補助金管理',
      description: 'AMED/NEDO業務日誌・収支管理',
      color: 'text-teal-500',
    },
    {
      href: '/procurement',
