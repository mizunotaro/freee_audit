...
export const DEFAULT_MODELS: Record<AIProviderType, string> = {
  ...
  gcp: 'gemini-2.5-flash-preview-05-20',
  freee: 'freee-ai',
  custom: 'custom-model',
}
...
export const MODEL_REGISTRY: ModelConfig[] = [
  {
    ...
    pricing: { inputToken: 0.2, outputToken: 1.25 },
  ...
  },
  {
    ...
    contextLength: 1048576,
    maxOutputTokens: 32768,
    pricing: { inputToken: 0.75, outputToken: 4.5 },
    capabilities: { vision: true, tools: true, json: true, streaming: true },
  },
  {
    provider: 'openai',
    ...
    contextLength: 1048576,
    maxOutputTokens: 32768,
    pricing: { inputToken: 2.5, outputToken: 15.0 },
    capabilities: { vision: true, tools: true, json: true, streaming: true },
  },
  {
    provider: 'openai',
  ...
  },
  {
    ...
    contextLength: 200000,
    maxOutputTokens: 16384,
    pricing: { inputToken: 1.0, outputToken: 5.0 },
    capabilities: { vision: true, tools: true, json: true, streaming: true },
  },
  {
    provider: 'claude',
    ...
    contextLength: 200000,
    maxOutputTokens: 16384,
    pricing: { inputToken: 5.0, outputToken: 25.0 },
    capabilities: { vision: true, tools: true, json: true, streaming: true },
  },
  {
    provider: 'claude',
  ...
  },
  {
    ...
    contextLength: 1048576,
    maxOutputTokens: 65536,
    pricing: { inputToken: 1.25, outputToken: 10.0 },
    capabilities: { vision: true, tools: true, json: true, streaming: true },
  },
  {
    provider: 'gemini',
  ...
  },
  {
    ...
    displayName: 'OpenAI GPT-5.4 Nano (via OpenRouter)',
    contextLength: 1048576,
    maxOutputTokens: 32768,
    pricing: { inputToken: 0.2, outputToken: 1.25 },
    capabilities: { vision: true, tools: true, json: true, streaming: true },
